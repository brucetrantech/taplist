...
import { addTask, deleteTask, listTasks, updateTask } from '@/modules/tasks/services';
        ...
        builder
            ...
            .addCase(updateTask.fulfilled, (state, payload) => {
                ...
                if (updatedData) {
                    ...
                    const update = temp.map(
                        item => item.uuid === updatedData.uuid ? updatedData : item,
                    );
                    state.list = update;
                }
            })
